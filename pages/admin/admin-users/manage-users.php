je vais te donner un code de base avec une structure a resepecter imperativement et tu ne dois rien ajouter juste faire en sorte que les prochain code que je vais te donner ressemble au code de base c'est tout
<?php
session_start();
